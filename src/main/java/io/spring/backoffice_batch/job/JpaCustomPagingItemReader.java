 ...
 * @since 2.0
 */
public class JpaCustomPagingItemReader<T> extends AbstractPagingItemReader<T> {
	...
	public JpaCustomPagingItemReader() {
		setName(ClassUtils.getShortName(JpaCustomPagingItemReader.class));
	}
