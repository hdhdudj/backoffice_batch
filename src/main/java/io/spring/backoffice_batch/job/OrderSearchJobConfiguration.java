...
public class OrderSearchJobConfiguration {
    ...
    public JpaPagingItemReader jpaOrderSearchItemWriterReader2() {
        ...
        jpaPagingItemReader.setEntityManagerFactory(entityManagerFactory);
        jpaPagingItemReader.setPageSize(chunkSize);
        jpaPagingItemReader.setQueryString("SELECT t FROM TbOrderDetail t join fetch t.ifOrderMaster i where i.ifStatus='02' and i.channelOrderStatus='p1' order by t.orderId asc");
