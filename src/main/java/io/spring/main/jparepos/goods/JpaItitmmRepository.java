...
public interface JpaItitmmRepository extends JpaRepository<Ititmm, ItitmmId> {
	...
	List<Ititmm> findByAssortIdAndVariationSeq1AndVariationSeq2AndVariationSeq3(String assortId, String variationSeq1,
			String variationSeq2, String variationSeq3);
